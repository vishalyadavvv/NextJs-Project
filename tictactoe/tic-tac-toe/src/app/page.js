        ...
        <header className="flex justify-between items-center mb-16 sm:mb-24">
          ...
          <div className="flex space-x-4">
            <button
              ...
              className="hidden sm:flex items-center space-x-2 bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 hover:border-gray-600/50 px-4 py-2 rounded-xl transition-all duration-300 transform hover:scale-105"
            >
